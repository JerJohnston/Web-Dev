...
toString() <-- converts an array into a string of CSV (comma seperated values) array values:
...
join()  <-- also joins all array elements into a string, the difference being that you can identify the seperator:
...
To add or remove elements from an array you can do so with either pop() or push().

pop()  <-- removes the last element from an array:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.pop();  <-- returns "Mango" the value that was "popped out" of the array.

push() <-- adds a new element to the end of an array:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.push("Kiwi");  <-- adds the new element "Kiwi" to the end of the array

this method also returns the new array length.  
...
Banana,Orange,Mango,Apple,Kiwi 

5

you can also remove elements using the shift() method, this will remove the first index instead of 
the last one and shift all of the other elements to a lower index:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.shift();  <-- removes the element "Banana" from the fruits array

shift() will also return the string that was shifted out.  

var x = fruits.shift()  will return the value of "Banana" into variable x.

unshift()  <-- adds a new element to the beginning of an array and unshifts the older elements:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.unshift("Lemon");

this method will also return the new array length.  

As we have learned, to access an element within an array, you may do so by accessing its index number
(which starts at 0).  

with the length property, you can easily append a new element into an array:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits[fruits.length] = "Kiwi";  <-- Appends "Kiwi" at the end of the fruits array. 

While you may use the Javascript operator delete to remove elements from an array, this could
leave undefined holes.  It is recommened to use pop() or shift() instead. 

To add more then one new item to an array you can use the splic() method:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.splice(2, 0, "Lemon", "Kiwi");

The first paramater (2) defines which position the new elements should be added, the second paramter (0)
defines how many elements should be removed.  

splice() <-- adds new elements to an array and returns the new array with the deleted elements:
...
splice() <-- may also remove elements without leaving holes in the array

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.splice(0, 1);     <-- removes the first element of fruits. 

concat() <-- creates a new array by merging two existing arrays:
...
concat() always returns a new array, it never changes an existing array. 

it can also take any number of array arguments:
...
concat() also takes strings as arguments. 

slice()  <-- slices out a piece of one array into a new array.

var fruits = ["Banana", "Orange", "Lemon", "Apple", "Mango"];
var citrus = fruits.slice(1);  <-- creates a new array starting from array element 1

the slice() method can take up to two arguments "slice(1, 3)" the method selects elements from the starting parameter
up to (but not including) the end argument. 

If the end argument is omitted then the slice() method will slice out the rest of the array.

sort() <-- sorts an array alphabetically:

var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.sort(); <-- sorts the elements of the fruits array

reverse() reverses the elements in an array

sort() treats values as strings which works well for arrays that are made up of pure strings. This makes it difficult
to sort numbers as sort() will place 25 after 100 because 2 is bigger then 1.  this can be fixed by providing a compare
function:

var points = [40, 100, 1, 5, 25, 10];
points.sort(function(a, b){return a - b});

to sort the array in descending order you would return b - a.

The compare function is used to define an alternative order, it should return a negative, zero or positive value depending 
on the arguments.  
...
function(a, b){return a - b}
    ...
    - Negative Result       A is sorted before B
    - Positive Result       B is sorted before A
    - Zero result           no changes are made to the sort order of the two values

e.g. 

The compare function compares all of the values in an array, two values at a time (a,b).  When comparing 40 and 100, the sort() method 
calls the compare function (40, 100), the function calculates 40 - 100 and since he result is negative (-60) the sort function will
sort 40 as a value lower then 100:
...
var points = [40, 100, 1, 5, 25, 10];
points.sort(function(a, b){return 0.5 - Math.random()}); <-- sorts the array in a random order.

However this method is not accurate and will favor some numbers over others.  The most popular
correct method is called the Fisher Yates Shuffle (introduced in 1938):
